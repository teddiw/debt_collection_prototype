node_to_retrieval_query_mapping = {
    ...
    "hasChargeOffBalance_1": "According to the business documents, what is the debt balance at charge-off (CA Civil Code § 1788.58 (a)(4))?",
    ...
    "hasPostChargeOffFeeExplanation_1": "What are the business documents that show the post-charge-off interest and fees (CA Civil Code § 1788.58 (a)(4))?",
    ...
    "chargeOffCreditorInfo_1": "According to the business records, what are the name and address of the charge-off creditor and the charge-off creditor's account number associated with the debt (CA Civil Code § 1788.58 (a)(6))?",
